...
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_dig_clk
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_local_ckp
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_local_ckn
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_rst_n
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_rst_ckp_n
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_rst_ckn_n
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_RCKP
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_RCKN
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_RTRK
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/i_clear_results
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/o_Clock_track_result_logged
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/iteration_counter_ckp
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/iteration_counter_ckn
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/iteration_counter_trk
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/shifting_counter_ckp
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/shifting_counter_ckn
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/sync_reg_ckp
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/sync_reg_ckn
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/sync_reg_track
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/sampled_ckp
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/sampled_ckn
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/sampled_track
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/eight_zeros_detect
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/zeros_found_ckp
add wave -noupdate -expand -group CLK_Detect /top/LTSM_SB_MB_inst_1/clock_detector_inst/zeros_found_ckn
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {306725819 ns} 0}
...
update
WaveRestoreZoom {306725690 ns} {306726543 ns}
